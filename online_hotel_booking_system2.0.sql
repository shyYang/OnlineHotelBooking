...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10000 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '123456', 1);
INSERT INTO `user` VALUES (2, '123456', 1);
INSERT INTO `user` VALUES (1000, '123456', 1);
INSERT INTO `user` VALUES (1001, '123456', 2);
